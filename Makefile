...
# same measurement was taken here before adding these two to `dist` below:
# stripped for ARM, snes9x2005 and beetle-pce-fast together add a couple of
# megabytes to a package that was 4 MB, which is nothing like the tenfold
