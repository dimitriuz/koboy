...
# measured until the split was questioned: the cores zip to 17.3 MB and the
# whole package to roughly 18.6 MB, because a 39 MB core of mostly-similar
# driver tables compresses hard. 18.6 MB is an unremarkable download, and it
...
#
# tests/test_dist.sh asserts all fifteen cores ARE in the package and that its
